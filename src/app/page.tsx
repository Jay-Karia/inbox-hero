...
export default function Home() {
  return (
    <div className="p-4 flex justify-center items-center flex-col gap-8">
      <h1 className="scroll-m-20 text-center text-5xl/16 font-extrabold tracking-tighter text-balance mt-18 animate-fade-in-up">
        Conquer your inbox
        <br />
        Become the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-yellow-500 animate-pulse">hero</span> of your day.
      </h1>
      ...
      <BackgroundGradient className="flex ">
        <div className="absolute z-50 inset-0 flex items-center justify-center text-white font-bold px-4 pointer-events-none text-3xl text-center ">
          <div className="border bg-gray-300 w-[60%] h-[60%] mt-24 rounded-lg">
